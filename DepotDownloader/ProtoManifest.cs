...
[ProtoContract]
internal sealed class ProtoManifest
{
    [ProtoContract]
    ...
    {
        if (sourceManifest.Files is null)
        {
            throw new InvalidOperationException("Cannot construct ProtoManifest from DepotManifest with null Files");
        }
